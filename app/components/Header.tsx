            ...
            <>
              ...
              <div className="fp-header-desktop" style={{ flex: 1, alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginLeft: 'auto', alignItems: 'center' }}>
                  ...
                  <Link href="/wishlist" style={{ position: 'relative', fontSize: 12, padding: '6px 14px', borderRadius: 20, border: '0.5px solid var(--color-border)', color: 'var(--color-text)', textDecoration: 'none', whiteSpace: 'nowrap' }}>
                    Wishlist
                    {wishlistCount > 0 && (
