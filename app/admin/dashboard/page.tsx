      ...
      <div className="container" style={{ paddingTop: 32, paddingBottom: 60 }}>
        ...
        {withdrawRequests.length > 0 && (
          <div style={{ background: '#FCEBEB', border: '0.5px solid #F09595', borderRadius: 8, padding: '10px 16px', marginBottom: 16, fontSize: 13, color: '#A32D2D' }}>
            ⚠️ {withdrawRequests.length} artist{withdrawRequests.length > 1 ? 's have' : ' has'} requested to withdraw. Check the Artists tab.
          </div>
        )}
        ...
        {tab === 'artists' && (
          <div>
            ...
            {withdrawRequests.length > 0 && (
              <div style={{ marginBottom: 24 }}>
                <p style={{ fontSize: 14, fontWeight: 500, marginBottom: 12, color: '#A32D2D' }}>⚠️ Withdrawal requests</p>
                <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
