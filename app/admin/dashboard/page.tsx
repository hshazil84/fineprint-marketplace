          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 16 }}>
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid #f4f4f0' }}>
                ...
                <td style={{ padding: '12px 0', fontSize: 13, color: '#444', verticalAlign: 'top' }}>{order.artworks?.profiles?.display_name || order.artworks?.profiles?.full_name}</td>
...
function getInvoiceHTML({ order, printingFee, hasOffer, date, buyerAddress }: any) {
  ...
  <td style="padding:12px 0;font-size:13px;color:#444;vertical-align:top">${order.artworks?.profiles?.display_name || order.artworks?.profiles?.full_name || ''}</td>
