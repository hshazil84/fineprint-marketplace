...
export function ListingsTab({ onBadgeRefresh }: { onBadgeRefresh: () => void }) {
  ...
  const [labelArtwork, setLabelArtwork]     = useState<any>(null)
  ...
  async function printArtworkLabel(artwork: any) {
    try {
      ...
      // Label size: 62 x 29mm — standard small sticker
      ...
      // Generate barcode on offscreen canvas
